...
export const EXPRESSION_TO_DETERMINE_VALUE_OF_IMPORT_LINE = /import.*from [\'\"](.*)[\/\'\"].*/ // Regex: import.*from ['"](.*)[/'"].*
export const EXPRESSION_TO_DETERMINE_VALUE_OF_MODULE_IMPORT_LINE = /import\s*[\'\"](.*)[\/\'\"].*/ // Regex: import\s*['"](.*)[/'"].*

export const EXPRESSION_TO_DETERMINE_VALUE_OF_REQUIRE_LINE = /.*=.*require\([\'\"](.*)[\/\'\"]\).*/ // Regex: .*=.*require\(['"](.*)[/'"]\).*
export const EXPRESSION_TO_DETERMINE_VALUE_OF_MODULE_REQUIRE_LINE = /require\([\'\"](.*)[\/\'\"]\).*/ // Regex: require\(['"](.*?)[/'"]
